...
function SetupQueues()
	CreateThread(function()
		for k, v in ipairs(_queues) do
			...
			exports['pulsar-core']:TasksRegister(v.id, v.wait, function(data)
				...
				while char == nil and #sources > 0 do
					...
					char = exports['pulsar-characters']:FetchCharacterSource(src)
					if char ~= nil then
				...
				if char ~= nil then
					...
					exports['pulsar-core']:LoggerInfo("Robbery Queue",
