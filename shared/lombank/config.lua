...
lbThermPoints = {
	lobbyGate = {
		...
		heading = 249.549,
		door = "pulsar_lombank_front_gate",
		requiredDoors = {},
	},
	vaultGate = {
		coords = vector3(24.04349, -932.0154, 30.25345),
		heading = 166.307,
		door = "pulsar_lombank_upper_gate",
		requiredDoors = {
			"pulsar_lombank_front_gate",
		},
	},
	upperVaultGate = {
		...
		requiredDoors = {
			"pulsar_lombank_front_gate",
			"pulsar_lombank_upper_gate",
			"pulsar_lombank_upper_vault",
		},
	},
	lowerVaultGate = {
	...
	lowerVaultRoom1 = {
		...
		requiredDoors = {
			"pulsar_lombank_front_gate",
			"pulsar_lombank_upper_gate",
			"pulsar_lombank_lasers",
			"pulsar_lombank_lower_vault",
		},
	},
	lowerVaultRoom2 = {
...
_lbHackPoints = {
	...
	lowerVaultDoor = {
		...
		door = "pulsar_lombank_lower_vault",
		forceOpen = true,
		requiredDoors = {
			"pulsar_lombank_front_gate",
			"pulsar_lombank_upper_gate",
