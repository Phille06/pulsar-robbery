...
lbThermPoints = {
	lobbyGate = {
		...
		heading = 249.549,
		door = "sandbox_lombank_front_gate",
		requiredDoors = {},
	},
	vaultGate = {
		coords = vector3(24.04349, -932.0154, 30.25345),
		heading = 166.307,
		door = "sandbox_lombank_upper_gate",
		requiredDoors = {
			"sandbox_lombank_front_gate",
		},
	},
	upperVaultGate = {
		coords = vector3(22.34634, -942.4745, 30.26073),
		heading = 249.518,
		door = "sandbox_lombank_upper_vault_gate",
		requiredDoors = {
			"sandbox_lombank_front_gate",
			"sandbox_lombank_upper_gate",
			"sandbox_lombank_upper_vault",
		},
	},
	lowerVaultGate = {
		coords = vector3(25.865, -929.0033, 26.09646),
		heading = 74.396,
		door = "sandbox_lombank_lower_gate",
		requiredDoors = {
			"sandbox_lombank_front_gate",
			"sandbox_lombank_upper_gate",
		},
	...
	lowerVaultRoom1 = {
		...
		heading = 76.141,
		door = "sandbox_lombank_lower_room_1",
		requiredDoors = {
			"sandbox_lombank_front_gate",
			"sandbox_lombank_upper_gate",
			"sandbox_lombank_lasers",
			"sandbox_lombank_lower_vault",
		},
	},
	lowerVaultRoom2 = {
		coords = vector3(33.44628, -917.2109, 26.08794),
		heading = 250.554,
		door = "sandbox_lombank_lower_room_2",
		requiredDoors = {
			"sandbox_lombank_front_gate",
			"sandbox_lombank_upper_gate",
			"sandbox_lombank_lasers",
	...
	lowerVaultRoom3 = {
		...
		heading = 76.141,
		door = "sandbox_lombank_lower_room_3",
		requiredDoors = {
			"sandbox_lombank_front_gate",
			"sandbox_lombank_upper_gate",
			"sandbox_lombank_lasers",
	...
	lowerVaultRoom4 = {
		...
		heading = 250.554,
		door = "sandbox_lombank_lower_room_4",
		requiredDoors = {
			"sandbox_lombank_front_gate",
			"sandbox_lombank_upper_gate",
			"sandbox_lombank_lasers",
...
_lbHackPoints = {
	upperVaultDoor = {
		...
		door = "sandbox_lombank_upper_vault",
		requiredDoors = {
			"lombank_front_gate",
			"lombank_upper_gate",
		},
	...
	lowerVaultDoor = {
		...
		door = "sandbox_lombank_lower_vault",
		forceOpen = true,
		requiredDoors = {
			"sandbox_lombank_front_gate",
			"sandbox_lombank_upper_gate",
